	...
	return (
		<div className="w-full pt-4">
			...
			<div className="flex flex-row h-16 w-1/4 mx-auto">
				<button className="h-full" onClick={dec}><Image src='/chevron-left.svg' alt="previous Track" height={32} width={32}></Image></button>
				...
				<button onClick={inc}><Image src='/chevron-right.svg' alt="next Track" height={32} width={32}></Image></button>
			</div>
		</div>
	)
}
